...
Assuming that last part is a reference to your log file.

Mailstat will show you a useful summary:
...
If you leave off the `-k` (for keep) it will show the same summary, move your log to log.old, and start a new log:
